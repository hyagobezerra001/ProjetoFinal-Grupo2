...
var config = {
    map: {
        "*": {
            "estshipping" : "Carbono_CalculatorShipping/js/customCatalogAddToCart",
			"swatchRenderer01" : "Carbono_CalculatorShipping/js/swatch-renderer01",
			"select2" : "Carbono_CalculatorShipping/js/standalone/select2.full"
		}
    },
	paths: {
		"estshipping" : "Carbono_CalculatorShipping/js/customCatalogAddToCart",
...
var config = {
    paths: {
        'jquery/mask': 'Webjump_Carbono/js/lib/jquery-mask'
    },
...
var config = {
    map: {
        '*': {
            cpfCnpjValidator: 'Webjump_CustomerBr/js/model/cpf-cnpj-validator',
            'Magento_Customer/js/logout-redirect': 'Webjump_CustomerBr/js/logout-redirect'
        }
    },
    config: {
        mixins: {
            'mage/validation': {
                'Webjump_CustomerBr/js/validator/cpf-cnpj': true,
                'Webjump_CustomerBr/js/validator/first-last-name': true
            },
            'Magento_Checkout/js/action/set-shipping-information': {
                'Webjump_CustomerBr/js/action/set-shipping-information-mixin': true
            }
        },
    }
};
